...
QT_MOC_LITERAL(1, 11, 8), // "resultat"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 2), // "re"
QT_MOC_LITERAL(4, 24, 12), // "faireCalcule"
QT_MOC_LITERAL(5, 37, 24), // "std::vector<std::string>"
QT_MOC_LITERAL(6, 62, 4) // "attr"

    },
    "traducteur\0resultat\0\0re\0faireCalcule\0"
    "std::vector<std::string>\0attr"
};
...
void traducteur::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->resultat((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->faireCalcule((*reinterpret_cast< std::vector<std::string>(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (traducteur::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&traducteur::resultat)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject traducteur::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_traducteur.data,
      qt_meta_data_traducteur,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void traducteur::resultat(int _t1)
{
